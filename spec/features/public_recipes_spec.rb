...
RSpec.feature 'Public Recipes Page', type: :feature do
  ...
  let(:public_recipes) do
    [
      Recipe.create(name: 'Recipe 1', description: 'Description 1', public: true, user: user),
      Recipe.create(name: 'Recipe 2', description: 'Description 2', public: true, user: user)
    ]
  end
