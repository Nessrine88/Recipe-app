...
RSpec.feature 'Inventories Index Page', type: :feature do
  ...
  let(:inventory1) { Inventory.create(name: 'Inventory 1', description: 'Description 1', user: user) }
  let(:inventory2) { Inventory.create(name: 'Inventory 2', description: 'Description 2', user: user) }
